...
export const Card = ({ event }) => {
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden w-full max-w-[100%] md:max-w-[370px] flex flex-col h-[268px] relative group cursor-pointer" onClick={() => window.open(event.link, "_blank")}>
      ...
      <div className="flex flex-col h-[85px] p-[16px] rounded-[16px] bg-[#F5F5F5] absolute bottom-0 left-0 right-0">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="border border-gray-300 rounded-full w-[56px] h-[40px] flex items-center justify-center hover:bg-gray-100 relative bottom-[10px] group hover:border-[#42AB5D] transition-all duration-400">
